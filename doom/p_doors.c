                ...
                case 117:
                    if (door->direction == -1)
                    ...
                    else
                        {
                            ...
                            // "specialdata" might not actually point at a
                            // door.
                            ...
                            if (door->thinker.function.acp1
                                     ...
                                     == (actionf_p1)T_PlatRaise)
                                {
                                    ...
                                    // This notably causes a problem in
                                    // ep1-0500.lmp where a plat and a door are
                                    // cross-referenced; the door doesn't open
                                    // on 64-bit. The direction field in
                                    // vldoor_t corresponds to the wait field
                                    // in plat_t.  Let's set that to -1
                                    // instead.
                                ...
                                {
                                    // This isn't a door OR a plat.  Now we're
                                    // in trouble.
                                    ...
                                    // Try closing it anyway. At least it will
