                    ...
                    if (netgame && !netdemo && !(gametic % ticdup))
                        {
                            if (gametic > BACKUPTICS
                                ...
                                {
                                    I_Error ("consistency failure (%i should "
                                             "be %i)",
                                             cmd->consistancy,
                                             consistancy[i][buf]);
                                }
    ...
    if (save_stream == NULL)
        {
            ...
            if (save_stream == NULL)
                {
                    I_Error ("Failed to open either '%s' or '%s' to write "
                             "savegame.",
    ...
    if (timingdemo)
        {
            ...
            I_Error ("timed %i gametics in %i realtics (%f fps)", gametic,
                     realtics, fps);
        }
