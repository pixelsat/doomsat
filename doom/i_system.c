    ...
    for (s = string; *s != '\0'; ++s)
        {
            ...
            //
            // Therefore, escape these characters by prefixing with a
            // backslash.
...
I_Error (char *error, ...)
{
    ...
    if (exit_gui_popup && !I_ConsoleStdout ())
#ifdef _WIN32
        {
            ...
            MultiByteToWideChar (CP_ACP, 0, msgbuf, strlen (msgbuf) + 1,
