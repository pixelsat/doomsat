...
struct doomsat_state
{
    ...
    int sectors_length;
    struct doomsat_sector *sectors;

    int sides_length;
    struct doomsat_side *sides;

    int lines_length;
    struct doomsat_line *lines;
...
doomsat_State ()
{
    ...
    state.player_viewz = players[displayplayer].viewz;
    state.player_extralight = players[displayplayer].extralight;
    state.player_fixedcolormap = players[displayplayer].fixedcolormap;
