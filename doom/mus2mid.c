...
static boolean
WriteChangeController_Valued (byte channel, byte control, byte value,
                              MEMFILE *midioutput)
{
...
static boolean
WriteChangeController_Valueless (byte channel, byte control,
                                 MEMFILE *midioutput)
{
            ...
            while (!hitscoreend)
                {
                    ...
                    switch (event)
                        ...
                        case mus_presskey:
                            ...
                            if (key & 0x80)
                                {
                                    if (mem_fread (&channelvelocities[channel],
                                                   1, 1, musinput)
                                        != 1)
                                        {
                                            return true;
