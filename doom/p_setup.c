            ...
            if (ldef->flags & ML_TWOSIDED)
                {
                    ...
                    // If the sidenum is out of range, this may be a "glass
                    // hack" impassible window.  Point at side #0 (this may not
                    // be the correct Vanilla behavior; however, it seems to
                    // work for OTTAWAU.WAD, which is the one place I've seen
                    // this trick used).
    ...
    if (len > sizeof (rejectpad))
        {
            ...
            // Pad remaining space with 0 (or 0xff, if specified on command
            // line).
            ...
            memset (array + sizeof (rejectpad), padvalue,
