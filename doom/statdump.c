...
static void
DiscoverGamemode (wbstartstruct_t *stats, int num_stats)
{
    int partime;
    int level;
    int i;
...
static int
GetNumPlayers (wbstartstruct_t *stats)
{
    int i;
    int num_players = 0;
...
static void
PrintPlayerStats (FILE *stream, wbstartstruct_t *stats, int player_num)
{
...
static void
PrintFragsTable (FILE *stream, wbstartstruct_t *stats)
{
    int x, y;
...
static void
PrintStats (FILE *stream, wbstartstruct_t *stats)
{
...
void
StatCopy (wbstartstruct_t *stats)
{
