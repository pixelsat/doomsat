...
void
I_InitScale (byte *_src_buffer, byte *_dest_buffer, int _dest_pitch)
{
...
static boolean
I_Scale1x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
    int w = x2 - x1;
...
static boolean
I_Scale2x (int x1, int y1, int x2, int y2)
{
...
static boolean
I_Scale3x (int x1, int y1, int x2, int y2)
{
...
static boolean
I_Scale4x (int x1, int y1, int x2, int y2)
{
...
static boolean
I_Scale5x (int x1, int y1, int x2, int y2)
{
...
static int
FindNearestColor (byte *palette, int r, int g, int b)
{
    byte *col;
    int best;
    int best_diff;
...
static byte *
GenerateStretchTable (byte *palette, int pct)
{
    byte *result;
    int x, y;
    int r, g, b;
            ...
            for (y = 0; y < 256; ++y)
                {
                    col1 = palette + x * 3;
                    col2 = palette + y * 3;
                    r = (((int)col1[0]) * pct + ((int)col2[0]) * (100 - pct))
                        / 100;
                    g = (((int)col1[1]) * pct + ((int)col2[1]) * (100 - pct))
                        / 100;
                    b = (((int)col1[2]) * pct + ((int)col2[2]) * (100 - pct))
                        / 100;
...
static void
I_InitStretchTables (byte *palette)
{
...
static void
I_InitSquashTable (byte *palette)
{
...
void
I_ResetScaleTables (byte *palette)
{
    if (stretch_tables[0] != NULL)
        {
...
static inline void
WriteBlendedLine1x (byte *dest, byte *src1, byte *src2, byte *stretch_table)
{
    int x;
...
static boolean
I_Stretch1x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteLine2x (byte *dest, byte *src)
{
    int x;
...
static inline void
WriteBlendedLine2x (byte *dest, byte *src1, byte *src2, byte *stretch_table)
{
    int x;
    int val;
...
static boolean
I_Stretch2x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteLine3x (byte *dest, byte *src)
{
    int x;
...
static inline void
WriteBlendedLine3x (byte *dest, byte *src1, byte *src2, byte *stretch_table)
{
    int x;
    int val;
...
static boolean
I_Stretch3x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteLine4x (byte *dest, byte *src)
{
    int x;
...
static inline void
WriteBlendedLine4x (byte *dest, byte *src1, byte *src2, byte *stretch_table)
{
    int x;
    int val;
...
static boolean
I_Stretch4x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteLine5x (byte *dest, byte *src)
{
    int x;
...
static boolean
I_Stretch5x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteSquashedLine1x (byte *dest, byte *src)
{
    int x;
...
static boolean
I_Squash1x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteSquashedLine2x (byte *dest, byte *src)
{
    byte *dest2;
    int x, c;
...
static boolean
I_Squash2x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteSquashedLine3x (byte *dest, byte *src)
{
    byte *dest2, *dest3;
    int x, c;
...
static boolean
I_Squash3x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteSquashedLine4x (byte *dest, byte *src)
{
    int x;
    int c;
...
static boolean
I_Squash4x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static inline void
WriteSquashedLine5x (byte *dest, byte *src)
{
    int x;
    int c;
...
static boolean
I_Squash5x (int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
