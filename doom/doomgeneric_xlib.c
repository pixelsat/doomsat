...
DG_Init ()
{
    ...
    s_Window = XCreateSimpleWindow (s_Display, DefaultRootWindow (s_Display),
    ...
    s_Image = XCreateImage (s_Display, DefaultVisual (s_Display, s_Screen),
                            depth, ZPixmap, 0, (char *)DG_ScreenBuffer,
