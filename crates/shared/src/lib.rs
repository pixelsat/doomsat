...
pub mod doom_serde {
    ...
    pub struct DoomsatState {
        ...
        pub paused: boolean,
        pub st_palette: i32,
        pub pagename: [core::ffi::c_char; 9],
        ...
        pub wi_state: i32,
        pub wi_epsd: i32,
        pub wi_didsecret: boolean,
        pub wi_last: i32,
        pub wi_next: i32,
        pub wi_cnt_kills: i32,
        pub wi_cnt_items: i32,
        pub wi_cnt_secret: i32,
        pub wi_cnt_time: i32,
        pub wi_cnt_par: i32,
        pub wi_snl_pointeron: boolean,
        pub wi_anim_ctr: [i32; 10],
    ...
    impl From<doomsat_state> for DoomsatState {
        fn from(value: doomsat_state) -> Self {
            ...
            DoomsatState {
                ...
                wi_state: value.wi_state,
                wi_epsd: value.wi_epsd,
                wi_didsecret: value.wi_didsecret,
                wi_last: value.wi_last,
                wi_next: value.wi_next,
                wi_cnt_kills: value.wi_cnt_kills,
                wi_cnt_items: value.wi_cnt_items,
                wi_cnt_secret: value.wi_cnt_secret,
                wi_cnt_time: value.wi_cnt_time,
                wi_cnt_par: value.wi_cnt_par,
                wi_snl_pointeron: value.wi_snl_pointeron,
                wi_anim_ctr: value.wi_anim_ctr,
    ...
    impl Into<doomsat_state> for &ArchivedDoomsatState {
        fn into(self) -> doomsat_state {
            doomsat_state {
                ...
                pagename: core::array::from_fn(|i| self.pagename[i].into()),
                ...
                wi_state: self.wi_state.into(),
                wi_epsd: self.wi_epsd.into(),
                wi_didsecret: self.wi_didsecret.into(),
                wi_last: self.wi_last.into(),
                wi_next: self.wi_next.into(),
                wi_cnt_kills: self.wi_cnt_kills.into(),
                wi_cnt_items: self.wi_cnt_items.into(),
                wi_cnt_secret: self.wi_cnt_secret.into(),
                wi_cnt_time: self.wi_cnt_time.into(),
                wi_cnt_par: self.wi_cnt_par.into(),
                wi_snl_pointeron: self.wi_snl_pointeron.into(),
                wi_anim_ctr: core::array::from_fn(|i| self.wi_anim_ctr[i].into()),
